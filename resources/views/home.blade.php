...
<head>
  ...
  <title>bajoride - Rent your favourite car</title>

  <!--
    - favicon
  -->
  <link rel="shortcut icon" href="{{asset('storage/assets/favicon.svg')}}" type="image/svg+xml">
...
<body>
    ...
    <div class="container">
      ...
      <div class="header-actions">
        ...
        <div class="header-contact">
          <a href="tel:88002345678" class="contact-link">081339731979</a>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{asset('storage/assets/images/car-1.jpg')}}" alt="Toyota RAV4 2021" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price-wrapper">
                    ...
                    <button class="btn" onclick="rent()">Rent now</button>
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-title">Neighborhoods in Labuan Bajo</p>
          </li>

          <li>
            <a href="#" class="footer-link">Kelimutu</a>
          </li>

          <li>
            <a href="#" class="footer-link">Wae Rebo</a>
          </li>

          <li>
            <a href="#" class="footer-link">Golo Mori</a>
          </li>

          <li>
            <a href="#" class="footer-link">Batu Cermin</a>
          </li>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          ...
          </script> <a href="https://it-bajo.vercel.app" target="_blank">it-bajo</a>. All Rights Reserved
        </p>
  ...
  <script src="./assets/js/rentScript.js"></script>
